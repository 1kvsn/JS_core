...
myPenguin.favoriteFoods = ["favone", "favtwo", "favthree",]
...
var firstFavFood = myPenguin.favoriteFoods[1];
// 4. Add another food to the end of the list.
myPenguin.favoriteFoods.push("favfour");
...
myPenguin.favoriteFoods.splice(3, 1, "pineapples");
